...
def sota_solvers(database, experiment_id):
    ...
    if form.i.data:
        ...
        def cached_sota_solvers(database, experiment_id, solver_config_ids, sc_names, instance_ids, job_count, last_modified_job, user_id):
            ...
            minimum_covering_set_solver_combinations = algorithms.ak_min_set_cover(set(solved_instance_ids), [set(solved_instances[sc_id]) for sc_id in solver_config_ids], solver_config_ids)
